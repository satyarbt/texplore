...
WebUI.click(findTestObject('HomePage/icon_settings'))

WebUI.scrollToElement(findTestObject('Settings/link_logout'), 0)

WebUI.click(findTestObject('Settings/link_logout'))
